...
namespace Articy.Vanflyta
{
    ...
    public class DefaultSupportingCharacterTemplate : Entity, IEntity, IPropertyProvider, IObjectWithFeatureDefaultBasicCharacterFeature
    {
        ...
        private static Articy.Vanflyta.Templates.DefaultSupportingCharacterTemplateTemplateConstraint mConstraints = new Articy.Vanflyta.Templates.DefaultSupportingCharacterTemplateTemplateConstraint();
        
        public Articy.Vanflyta.Templates.DefaultSupportingCharacterTemplateTemplate Template
        {
            get
            {
        ...
        public static Articy.Vanflyta.Templates.DefaultSupportingCharacterTemplateTemplateConstraint Constraints
        {
            get
            {
                return mConstraints;
        ...
        protected override void CloneProperties(object aClone, Articy.Unity.ArticyObject aFirstClassParent)
        {
            ...
            if ((Template != null))
            {
                newClone.Template = ((Articy.Vanflyta.Templates.DefaultSupportingCharacterTemplateTemplate)(Template.CloneObject(newClone, aFirstClassParent)));
            }
