...
namespace Articy.Vanflyta.Features
{
    ...
    public class DefaultBasicCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Vanflyta.Features.DefaultBasicCharacterFeatureFeature newClone = ((Articy.Vanflyta.Features.DefaultBasicCharacterFeatureFeature)(aClone));
            newClone.Age = Age;
            if ((mSpecies != null))
            {
        ...
        {
            Articy.Vanflyta.Features.DefaultBasicCharacterFeatureFeature clone = new Articy.Vanflyta.Features.DefaultBasicCharacterFeatureFeature();
