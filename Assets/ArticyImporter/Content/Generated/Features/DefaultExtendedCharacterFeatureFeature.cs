...
namespace Articy.Vanflyta.Features
{
    ...
    public class DefaultExtendedCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Vanflyta.Features.DefaultExtendedCharacterFeatureFeature newClone = ((Articy.Vanflyta.Features.DefaultExtendedCharacterFeatureFeature)(aClone));
            if ((mMotivation != null))
            {
        ...
        {
            Articy.Vanflyta.Features.DefaultExtendedCharacterFeatureFeature clone = new Articy.Vanflyta.Features.DefaultExtendedCharacterFeatureFeature();
