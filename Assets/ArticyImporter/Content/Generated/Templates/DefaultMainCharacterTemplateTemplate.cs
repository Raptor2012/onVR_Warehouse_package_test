...
using Articy.Vanflyta.Features;
using System;
...
namespace Articy.Vanflyta.Templates
{
    ...
    public class DefaultMainCharacterTemplateTemplate : IArticyBaseObject, IPropertyProvider
    {
        ...
        public Articy.Vanflyta.Features.DefaultExtendedCharacterFeatureFeature DefaultExtendedCharacterFeature
        {
            get
            {
        ...
        public Articy.Vanflyta.Features.DefaultBasicCharacterFeatureFeature DefaultBasicCharacterFeature
        {
            get
            {
        ...
        {
            Articy.Vanflyta.Templates.DefaultMainCharacterTemplateTemplate newClone = ((Articy.Vanflyta.Templates.DefaultMainCharacterTemplateTemplate)(aClone));
            if ((DefaultExtendedCharacterFeature != null))
            {
                newClone.DefaultExtendedCharacterFeature = ((Articy.Vanflyta.Features.DefaultExtendedCharacterFeatureFeature)(DefaultExtendedCharacterFeature.CloneObject(newClone, aFirstClassParent)));
            }
            if ((DefaultBasicCharacterFeature != null))
            {
                newClone.DefaultBasicCharacterFeature = ((Articy.Vanflyta.Features.DefaultBasicCharacterFeatureFeature)(DefaultBasicCharacterFeature.CloneObject(newClone, aFirstClassParent)));
            }
        ...
        {
            Articy.Vanflyta.Templates.DefaultMainCharacterTemplateTemplate clone = new Articy.Vanflyta.Templates.DefaultMainCharacterTemplateTemplate();
